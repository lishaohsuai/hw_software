...
class LR:
    def __init__(self, train_file_name, test_file_name, predict_result_file_name):
        ...
        self.predict_label_file="data/answer.txt" #'data/answer.txt'
        self.max_iters = 50
        self.rate = 0.45
    ...
    def model(self):
        ...
        for i in range(self.max_iters):
            ...
            #if test_accuracy >70 :
                #break;
        #self.savePredictResult(np.squeeze(predict(X)))
...
if __name__ == "__main__":
    ...
    predict_file = "data/result.txt" #/projects/student
